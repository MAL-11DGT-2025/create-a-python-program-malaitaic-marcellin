def tell_a_story(age, name, car, food, whanau, game):
    ...
    print(f"Kia ora {name}, I also enjoy playing {game}. I think {age} is too old and you should learn how to drive a {car}. I am planning to buy {food} tonight and make fun of {whanau}.")
